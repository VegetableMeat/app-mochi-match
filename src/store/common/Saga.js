...
export const adminTitleUpdateSaga = [takeLatest(ADMIN_GAME_TITLE_UPDATE_REQ, fetchAdminGameTitleUpdate)];

export const adminHardSaga = [takeLatest(ADMIN_GAME_HARD_GET_REQ, fetchAdminHardGet), takeLatest(ADMIN_GAME_HARD_ADD_REQ, fetchAdminGameHardAdd), takeLatest(ADMIN_GAME_HARD_DELETE_REQ, fetchAdminGameHardDelete), takeLatest(ADMIN_GAME_HARD_UPDATE_REQ, fetchAdminGameHardUpdate)];
