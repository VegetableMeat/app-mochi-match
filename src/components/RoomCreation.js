            ...
            <Body>
                <CenterMainBody>
                    ...
                    <div className="section">
                        ...
                        <div className="section-inner-wrapper">
                            <div class="radio">
                                <div><input type="radio" name="time"></input><label>即時</label></div>
                                <div><input type="radio" name="time"></input><label>時間指定</label></div>
                                <div><input type="radio" name="time"></input><label>未定</label></div>
                            </div>
